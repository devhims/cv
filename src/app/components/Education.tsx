...
function EducationItem({ education }: EducationItemProps) {
  ...
  return (
    <Card className="print:mb-1 print:py-0">
      ...
      <CardContent
        className="mt-2 text-xs text-muted-foreground print:mt-0.5 print:p-2 print:pt-1 print:text-[10px] print:leading-tight"
...
export function Education({ education }: EducationListProps) {
  return (
    <Section>
      <h2 className="text-xl font-bold print:text-lg" id="education-section">
        Education
      </h2>
      <div
